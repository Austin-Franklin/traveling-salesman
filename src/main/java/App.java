...
public class App {
    public static void main(String[] args) {
        ...
        int totalAnnealRuns = 500 + addressList.size() * 20;

        //how many times do crossovers occur
        int totalCrossovers = 5 + addressList.size() * 2;
        ...
        //a 50% chance of taking a longer route at the start due to boltzmann factor
        //0.5 = exp(-deltaE/kT), rearrange for k it is deltaE / (ln(2) * T)
        ...
        double boltzmannFactor = 1e6 * addressList.size() / (Math.log(2) * totalAnnealRuns);
